...
namespace Haiku.API.Utilities
{
    public class GlobalExceptionHandlerUtility
    {
        ...
        private readonly ILogger<GlobalExceptionHandlerUtility> _logger;

        public GlobalExceptionHandlerUtility(RequestDelegate next, ILogger<GlobalExceptionHandlerUtility> logger)
        {
            _next = next;
            _logger = logger;
        }
